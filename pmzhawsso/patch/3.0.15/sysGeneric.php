...
if (defined( 'SYS_TEMP' ) && SYS_TEMP != '') {
    ...
    if (SYS_TARGET === 'newSite') {
		...
		// ZHAW login hook
		$SSOByPass = PATH_PLUGINS . '/pmzhawsso/zhawLogin.php';
		if (file_exists($SSOByPass) && file_exists(PATH_PLUGINS . '/pmzhawsso/enabled.txt')) {
			require_once($SSOByPass) ;
			die();
		}
